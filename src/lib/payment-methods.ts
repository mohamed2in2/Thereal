...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  /* ─── Sha7nawy Gateway (gate.sha7nawy.com) ─────────────────────────── */
  {
    ...
    description: "الدفع المباشر عبر محفظة فودافون كاش (بوابة إلكترونية).",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#E60000",
    ...
    available: false,
    unavailableNote: "بوابة الدفع التلقائي للمحافظ متوقفة مؤقتاً — يرجى استخدام كود الشحن / القسيمة أو الشحن بالرصيد",
  ...
  },
  {
    ...
    description: "الدفع عبر محفظة اتصالات كاش أو تطبيق e& Money.",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#76B900",
  ...
  /* ─── Shake-Out Gateway (dash.shake-out.com) — Fawry only ────────────── */
  {
    ...
    description: "الدفع برقم مرجعي عبر منافذ فوري وأكشاك التحصيل.",
    category: "kiosk",
    provider: "shakeout",
    brandColor: "#FFCC00",
    ...
    available: false,
    unavailableNote: "بوابة فوري التلقائية متوقفة مؤقتاً — يرجى استخدام كود الشحن أو التحويل المباشر",
