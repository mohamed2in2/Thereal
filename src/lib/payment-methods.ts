...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  ...
  },
  {
    ...
    requiresReference: false,
    available: false,
    unavailableNote: "غير متاحة حالياً عبر البوابة المباشرة — يرجى اختيار فودافون كاش أو فوري، أو التواصل عبر الواتساب",
    processingSpeed: "تأكيد فوري",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "يرجى اختيار فودافون كاش أو فوري",
    instructions: [],
  },
  {
    id: "et_cash",
    ...
    requiresReference: false,
    available: false,
    unavailableNote: "غير متاحة حالياً عبر البوابة المباشرة — يرجى اختيار فودافون كاش أو فوري",
    processingSpeed: "تأكيد فوري",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
  ...
  },
  {
    ...
    description: "ادفع باستخدام أي بطاقة خصم مباشر أو ائتمان.",
    category: "card",
    provider: "shakeout",
    brandColor: "#1A1F71",
    brandForeground: "#FFFFFF",
    ...
    requiresReference: false,
    available: false,
    unavailableNote: "غير متاحة حالياً عبر البوابة الإلكترونية — يرجى استخدام فودافون كاش أو فوري",
  ...
  {
    id: "meeza",
    label: "بطاقة ميزة الوطنية",
    labelEn: "Meeza Card",
    description: "ادفع بكل سهولة عبر بطاقة ميزة الوطنية المصرية.",
    category: "card",
    provider: "shakeout",
    brandColor: "#007A3D",
    brandForeground: "#FFFFFF",
