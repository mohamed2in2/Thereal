...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  /* ─── Sha7nawy Gateway (gate.sha7nawy.com) ─────────────────────────── */
  {
    ...
    description: "احصل على رقم مرجعي وسدد من أي كشك أو منفذ فوري أو عبر تطبيق Fawry yellow card.",
    category: "kiosk",
    provider: "sha7nawy",
    brandColor: "#FFC20E",
    ...
    minAmount: 10,
    maxAmount: 20000,
    shortNote: "احتفظ بالرقم المرجعي وسدد في أي فرع أو كشك فوري خلال ساعتين",
    instructions: [
      "سيظهر لك رقم مرجعي (Fawry Reference Number) مكون من أرقام بعد إدخال هاتفك.",
      "توجه لأقرب كشك، سوبرماركت، أو منفذ فوري.",
      "اطلب من التاجر الدفع عبر «خدمة فوري مدفوعات إلكترونية / Sha7nawy».",
      "أعطه الرقم المرجعي وسدد المبلغ المطلوب.",
      "سيتم تأكيد العملية وشحن رصيدك فوراً وبشكل آلي.",
    ],
  },
  {
    id: "vf_cash",
    ...
    description: "ادفع فوراً من محفظة فودافون كاش عبر هاتفك المحمول (بوابة Sha7nawy).",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#E60000",
  ...
  },
  {
    ...
    requiresReference: false,
    available: false,
    unavailableNote: "غير متاحة حالياً — يرجى استخدام محفظة فودافون كاش أو فوري",
    processingSpeed: "تأكيد فوري",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "طريقة غير متاحة حالياً — يرجى اختيار فودافون كاش",
    instructions: [],
  },
  {
    id: "or_cash",
    ...
    requiresReference: false,
    available: true,
    processingSpeed: "تأكيد فوري (#115#)",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "اطلب #115# أو افتح تطبيق My Orange واقبل طلب الدفع",
    instructions: [
      "سيصلك إشعار بطلب الخصم على رقم محفظتك.",
      "اطلب #115# من هاتفك أو افتح تطبيق My Orange.",
      "اختر موافقة المعاملات المعلقة وأدخل الرقم السري.",
      "سيتم الاعتماد وتأكيد الشحن فوراً.",
    ],
  },
  {
    id: "smart_wallet",
    label: "محفظة CIB Smart Wallet",
    labelEn: "CIB Smart Wallet",
    description: "ادفع مباشرة من المحفظة الذكية للبنك التجاري الدولي (بوابة Sha7nawy).",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#002F6C",
    brandForeground: "#FFFFFF",
    ...
    requiresReference: false,
    available: true,
    processingSpeed: "تأكيد فوري من التطبيق",
    feePercentage: 2,
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "اقبل طلب الدفع داخل تطبيق CIB Smart Wallet",
    instructions: [
      "افتح تطبيق Smart Wallet الخاص بالبنك التجاري الدولي.",
      "وافق على الطلب المعلق وأدخل الرقم السري للعملية.",
      "سيتم استكمال الشحن وتأكيد رصيدك فوراً.",
    ],
  },
  {
    id: "bm_wallet",
    label: "محفظة بنك مصر (BM Wallet)",
    labelEn: "Banque Misr Wallet",
    description: "سدد من محفظة بنك مصر الذكية على رقم هاتفك المحمول (بوابة Sha7nawy).",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#800020",
    brandForeground: "#FFFFFF",
    ...
    minAmount: 5,
    maxAmount: 10000,
    shortNote: "اقبل طلب الدفع من داخل تطبيق محفظة بنك مصر",
    instructions: [
      "افتح تطبيق محفظة بنك مصر على هاتفك.",
      "اختر الإشعارات أو طلبات الدفع المعلقة ووافق على السحب.",
      "أدخل الرقم السري للمحفظة للتأكيد الفوري.",
    ],
  },
  ...
  /* ─── Shake-Out Gateway (dash.shake-out.com) ────────────────────────── */
  {
    ...
    requiresReference: false,
    available: false,
    unavailableNote: "غير متاحة حالياً من مزود الخدمة — يرجى استخدام فودافون كاش أو فوري",
  ...
  /* ─── Disabled / Unverified Gateway Methods ───────────────────────── */
  {
    ...
    requiresReference: true,
    available: false,
    unavailableNote: "غير متاحة حالياً عبر البوابة — يرجى اختيار إحدى الوسائل المفعلة (فوري، أورانج كاش، أو فودافون كاش)",
