...
export const PAYMENT_METHODS: readonly PaymentMethodConfig[] = [
  {
    id: "vf_cash",
    label: "فودافون كاش (خصم مباشر تلقائي)",
    labelEn: "Vodafone Cash (Auto Debit)",
    description: "ادفع فوراً وبأمان من محفظة فودافون كاش بطلب خصم على هاتفك المحمول.",
    category: "wallet",
    provider: "sha7nawy",
    brandColor: "#E60000",
  ...
  },
  {
    ...
    description: "تحويل لحظي مباشر عبر تطبيق InstaPay مصر أو الحسابات البنكية بدون رسوم إضافية.",
    category: "instant",
    provider: "internal",
    brandColor: "#5A2D82",
    brandForeground: "#FFFFFF",
    ...
    minAmount: 1,
    maxAmount: 50000,
    shortNote: "حوّل المبلغ المطلوب عبر InstaPay ثم أرسل إشعار التحويل للتفعيل الفوري",
    instructions: [
      "افتح تطبيق InstaPay مصر على هاتفك.",
      "اختر تحويل الأموال وأدخل رقم الحساب أو عنوان الدفع (IPA).",
      "أدخل المبلغ المطلوب بالضبط وأكّد التحويل برقمك السري.",
      "اضغط على زر «إرسال إشعار التحويل عبر واتساب» لتفعيل حسابك ومشترياتك فوراً.",
    ],
  },
  {
    id: "fawry",
